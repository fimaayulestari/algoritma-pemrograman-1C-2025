...
print ("Total harga yang harus di bayar : Rp ",int (total_harga_setelah_pajak))

# soal 2
panjang = input("Masukkan nilai panjang balok: ")
...
kombinasi = 14 * 13 * 12 // (3 * 2 * 1) # 14! / (3! * (14 - 3)!) = 14! / (3! * 11!) = 14 * 13 * 12 / (3 * 2 * 1) Jadi 11! nya di coret
print("Jumlah cara mengambil 3 bola secara acak adalah: ", kombinasi)
#cara ini hanya untuk menghitung kombinasi 14 ambil 3, jika ingin menghitung kombinasi lain harus diubah rumusnya
